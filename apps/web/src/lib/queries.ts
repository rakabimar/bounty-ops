...
export const coreQ = {
  ...
  assetDetail: (id:string) => queryOptions({queryKey:["core","asset-detail",id],queryFn:()=>coreApi.getAssetDetail(id)}),
  assetUrls: (id:string,filters:Parameters<typeof coreApi.getAssetUrls>[1]={}) => queryOptions({queryKey:["core","asset-urls",id,filters],queryFn:()=>coreApi.getAssetUrls(id,filters)}),
  assetEndpoints: (id:string,filters:Parameters<typeof coreApi.getAssetEndpoints>[1]={}) => queryOptions({queryKey:["core","asset-endpoints",id,filters],queryFn:()=>coreApi.getAssetEndpoints(id,filters)}),
  assetFindings: (id:string,filters:Parameters<typeof coreApi.getAssetScannerFindings>[1]={}) => queryOptions({queryKey:["core","asset-findings",id,filters],queryFn:()=>coreApi.getAssetScannerFindings(id,filters)}),
  urls: (filters:Parameters<typeof coreApi.getUrls>[0]={}) => queryOptions({queryKey:["core","urls",filters],queryFn:()=>coreApi.getUrls(filters)}),
  urlDetail: (id:string) => queryOptions({queryKey:["core","url-detail",id],queryFn:()=>coreApi.getUrlDetail(id)}),
  endpoints: (filters:Parameters<typeof coreApi.getEndpoints>[0]={}) => queryOptions({queryKey:["core","endpoints",filters],queryFn:()=>coreApi.getEndpoints(filters)}),
